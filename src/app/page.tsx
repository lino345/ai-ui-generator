...
export default function Home() {
  ...
  /* ⭐ LIVE PREVIEW AUTO SCROLL */
  const previewBottomRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    previewBottomRef.current?.scrollIntoView({
      behavior: "smooth",
      block: "end",
    });
  }, [activeIndex, versions]);
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen px-4 md:px-10 py-6 md:py-12 gap-6 md:gap-8">

      {/* LEFT PANEL */}
      <div className="w-full lg:w-1/3 bg-white shadow-2xl p-6 md:p-10 flex flex-col">
      ...
      {/* RIGHT PANEL */}
      <div className="w-full lg:w-2/3 p-4 md:p-10 space-y-8">
     ...
     <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl p-6 space-y-6">
